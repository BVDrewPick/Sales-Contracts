        ...
        <div style={{
            ...
            {isMobile ? (
                <>
                    <div style={{ display: 'flex', borderBottom: '1px solid #ccc' }}>
                        <button 
                            ...
                            style={{ 
                                flex: 1, 
                                padding: '10px', 
                                backgroundColor: activeTab === 'canvas' ? '#e0e0e0' : 'white',
                                border: 'none',
                        ...
                        <button 
                            ...
                            style={{ 
                                flex: 1, 
                                padding: '10px', 
                                backgroundColor: activeTab === 'controls' ? '#e0e0e0' : 'white',
                                border: 'none'
                            }}
                        >
                            Controls
                    ...
                    {activeTab === 'canvas' ? renderCanvasArea() : renderControls()}
                </>
            ) : (
